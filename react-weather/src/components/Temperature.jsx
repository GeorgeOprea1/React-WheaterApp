    ...
    <div className="w-[100%] h-[100%] flex flex-col justify-around ">
      ...
      <div className="flex justify-center mt-8 ">
        {stats.isDay === 0 ? (
          ...
          <IoSunnyOutline className="text-yellow-300 cursor-pointer w-12 h-12 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out" />
        )}
      </div>
